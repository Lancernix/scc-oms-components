 ...
 */
export function momentToSecond(params) {
 ...
 */
export function momentToMillisecond(params) {
 ...
 */
export function momentToString(params) {
 ...
 */
export function momentToValue(params, valueType) {
 ...
 */
export function stringToMoment(timeString, format) {
  var realFormat = format !== null && format !== void 0 ? format : 'YYYY-MM-DD HH:mm:ss';
  var res = moment(timeString, realFormat);
 ...
 */
export function secondToMoment(params) {
  return _Number$isInteger(params) ? moment.unix(params) : void 0;
}
 ...
 * @returns moment对象，如果入参不是一个integer，则返回undefined
 */
export function millisecondToMoment(params) {
  return _Number$isInteger(params) ? moment(params) : void 0;
}
 ...
 */
export function valueToMoment(params) {
  var format = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'YYYY-MM-DD HH:mm:ss';
